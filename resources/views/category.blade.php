                            ...
                            <div class="d-flex align-items-center flex-wrap">
                                <div class="aside-header pr-0 d-flex align-items-center mb-4 mb-sm-0">
                                    <div class="aside-header-btn d-flex justify-content-end position-relative">
                                        ...
                                        <a href="{{ url('admin/add-category') }}" class="btn-circle style--two">
                                ...
                                <div class="d-flex align-items-center mr-4 mr-xl-5 ml-xl-n2 mb-4 mb-sm-0">
                                    ...
                                    <div class="">
                                        <p class="mb-1 font-14 l-height1">Category</p>
                                        <h4>{{ $count }}</h4>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center mr-4 mr-xl-5 ml-xl-n2 mb-4 mb-sm-0">
                    ...
                    <div class="table-responsive">
                        <div class="product-statistics">
                            <div class="statistic-row pb-1">
                                ...
                                <div class="bold">Category slug</div>
                            ...
                            <div class="statistic-row pt-2">
                                ...
                                <a href="{{asset('storage/media/'.$list->image)}}" target="_blank"> <img src="{{asset('storage/media/'.$list->image)}}" alt=""/></a>
                                 ...
                                 @endif
                                {{ $list->category_name }}</div>
                               
                                <div>{{ $list->category_slug }}
                                        </div>
                                <div class="text-center">
                                    @if($list->status=='0')
                                       <a href="{{url('admin/category/status/1')}}/{{$list->id}}" class="status-btn un_paid">Active</a>
                                    @else
                                       <a href="{{url('admin/category/status/0')}}/{{$list->id}}" class="status-btn paid">Deactive</a>
                                    @endif
                                </div>
                                <div>
                                    <div class="dropdown-button icon"> 
                                        <a href="{{ url('admin/category/delete')}}/{{$list->id}}"><i class="icofont-bin" style="font-size: 24px;color:red"></i></a> &nbsp;&nbsp;   
                                        <a href="{{ url('admin/category/edit')}}/{{$list->id}}"><i class="icofont-edit" style="font-size: 20px;color:white"></i></a>  
                                    </div>
